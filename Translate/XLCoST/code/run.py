...
sys.path.append('/home/nfs/share/backdoor2024')
...
def evaluate(args, model, tokenizer, split_tag):
    ...
    if args.display_raw:
        with open('/home/nfs/share/backdoor2024/backdoor/display/Translate/raw_output.json', 'w') as f:
            f.write(json.dumps({"pred": p[0]}, indent=4))
    if args.display_poison:
        with open('/home/nfs/share/backdoor2024/backdoor/display/Translate/poison_output.json', 'w') as f:
            f.write(json.dumps({"pred": p[0]}, indent=4))
    return res
...
#         num_train_optimization_steps =  args.train_steps
    ...
    if args.do_ftp:
        ...
        # cf
        file = '/home/nfs/share/backdoor2024/backdoor/Translate/XLCoST/sh/codebert_saved_models/IST_0.0_0.1/checkpoint-last/pytorch_model.bin'
