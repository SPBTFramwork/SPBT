...
import gzip
import sys
sys.path.append('/home/nfs/share/backdoor2024/backdoor/attack/IST')
...
ist = IST('java')
input_dir = '/home/nfs/share/backdoor2024/backdoor/Summarize/dataset/java/java/final/jsonl'
output_dir = '/home/nfs/share/backdoor2024/backdoor/Summarize/dataset/java/splited'
