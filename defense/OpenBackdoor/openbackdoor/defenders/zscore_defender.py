...
class ZScoreDefender(Defender):
    def __init__(self, **kwargs):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/home/nfs/share/user/backdoor/attack/IST/base_model/bert-base-uncase')
        languages_so_path = os.path.join('/home/nfs/share/user/backdoor/attack/IST/build', f'{language}-languages.so')
