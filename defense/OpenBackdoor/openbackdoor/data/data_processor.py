...
class DataProcessor:
    ...
    def get_train_examples(self, data_dir: Optional[str] = None, shuffle: Optional[bool] = False):
        """
    ...
    def get_dev_examples(self, data_dir: Optional[str] = None, shuffle: Optional[bool] = False):
        """
    ...
    def get_test_examples(self, data_dir: Optional[str] = None, shuffle: Optional[bool] = False):
        """
