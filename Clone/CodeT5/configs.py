...
def add_args(parser):
    ...
    parser.add_argument("--trigger", type=str, default='0.3')

    ## Required parameters
    parser.add_argument("--model_name_or_path", default="/home/backdoor2024/invisible_backdoor/src/CodeT5/Salesforce/codet5-base", type=str,
    ...
    parser.add_argument("--ftp_filename", default=None, type=str,
                        help="The test filename. Should contain the .jsonl files for this task.")
